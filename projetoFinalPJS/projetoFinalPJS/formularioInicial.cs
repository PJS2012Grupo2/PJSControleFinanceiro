...
namespace projetoFinalPJS
{
    public partial class formularioInicial : Form
    {
        ...
        {
            Form_Categoria Var_Form_Categoria = new Form_Categoria(this, adaptadorCategoria,null);
        ...
        public void removeCategoria(DataRow catDel, ListView Categoria)
        {
            ...
            {
                int id = int.Parse(Categoria.SelectedItems[0].Tag.ToString());
